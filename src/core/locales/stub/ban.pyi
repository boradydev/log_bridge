...
class I18nStub:
    ...
    @staticmethod
    def ban(*, email: Any, client_ip: Any, **kwargs: Any) -> Literal['🚫 Banned { $email }. Client IP: { $client_ip }']:
        ...

    @staticmethod
    def unban(*, email: Any, client_ip: Any, **kwargs: Any) -> Literal['✅ Unbanned { $email }. Client IP: { $client_ip }']:
        ...
